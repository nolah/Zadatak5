...
public class UpdateAirlineRequest implements Serializable {
    ...
    private UpdateAirlineRequest() {
    }

    public UpdateAirlineRequest(Long id, String name, String description, String luggageDetails) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final UpdateAirlineRequest other = (UpdateAirlineRequest) obj;
    ...
    public String toString() {
        return "UpdateAirlineRequest[" + "this.id=" + this.id + ", this.name=" + this.name + ", this.description=" + this.description + ", this.luggageDetails=" + this.luggageDetails + "]";
    }
