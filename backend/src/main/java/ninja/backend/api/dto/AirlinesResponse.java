...
public class AirlinesResponse implements Serializable {
    ...
    private AirlinesResponse() {
    }

    public AirlinesResponse(Long id, String name, String description, String luggageDetails) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final AirlinesResponse other = (AirlinesResponse) obj;
    ...
    public String toString() {
        return "AirlinesResponse[" + "this.id=" + this.id + ", this.name=" + this.name + ", this.description=" + this.description + ", this.luggageDetails=" + this.luggageDetails + "]";
    }
