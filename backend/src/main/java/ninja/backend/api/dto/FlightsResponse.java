...
public class FlightsResponse implements Serializable {
    ...
    public FlightsResponse(Long id, Long aircraftId, ZonedDateTime timestamp, Integer numberOfEconomySeats, Integer freeEconomySeats, BigDecimal priceOfEconomySeat, Integer numberOfBusinessSeats,
            Integer freeBusinessSeats, BigDecimal priceOfBusinessSeats, String fromAirport, String toAirport, String aircraftMaker, String aircraftType, Long aircraftAirlineId, Long airlineId,
            String airlineName, String airlineDescription, String airlineLuggageDetails) {
        this.id = id;
    ...
    public String toString() {
        return "FlightsResponse[" + "this.id=" + this.id + ", this.aircraftId=" + this.aircraftId + ", this.timestamp=" + this.timestamp + ", this.numberOfEconomySeats=" + this.numberOfEconomySeats
                ...
                + this.toAirport + ", this.aircraftMaker=" + this.aircraftMaker + ", this.aircraftType=" + this.aircraftType + ", this.aircraftAirlineId=" + this.aircraftAirlineId
                + ", this.airlineId=" + this.airlineId + ", this.airlineName=" + this.airlineName + ", this.airlineDescription=" + this.airlineDescription + ", this.airlineLuggageDetails="
                + this.airlineLuggageDetails + "]";
    }
