...
public class TimeDto implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.minutes != null && other.minutes != null && !this.minutes.equals(other.minutes))
            return false;
        if (this.totalMilliseconds != null && other.totalMilliseconds != null && !this.totalMilliseconds.equals(other.totalMilliseconds))
            return false;
        return true;
    }
    ...
    public String toString() {
        return "TimeDto[" + "this.days=" + this.days + ", this.hours=" + this.hours + ", this.minutes=" + this.minutes + ", this.totalMilliseconds=" + this.totalMilliseconds + "]";
    }
