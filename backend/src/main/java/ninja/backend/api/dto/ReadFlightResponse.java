...
public class ReadFlightResponse implements Serializable {
    ...
    public ReadFlightResponse(Long id, Long aircraftId, ZonedDateTime timestamp, Integer numberOfEconomySeats, BigDecimal priceOfEconomySeat, Integer numberOfBusinessSeats,
